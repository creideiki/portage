...
EGO_SUM=(
	...
	"github.com/aws/aws-sdk-go v1.40.0/go.mod"
	...
	"github.com/microcosm-cc/bluemonday v1.0.15/go.mod"
	...
	"github.com/schollz/sqlite3dump v1.3.0/go.mod"
	"github.com/shirou/gopsutil v3.21.6+incompatible"
	"github.com/shirou/gopsutil v3.21.6+incompatible/go.mod"
...
src_compile() {
	go build -v -work -x \
	   -ldflags "-s -w -X github.com/${PN}/${PN}/config.BuildVersion=${PV} -X github.com/${PN}/${PN}/config.BuildPlatform=gentoo" \
	   -o ${PN} \
